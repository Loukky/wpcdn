    ...
    function vfhkyconlocquery(){
        $(".vfhkyconlocquery").each(function(){
            ...
            $.getScript("https://geoip.loukky.com/?js=1&ip="+c,function(){
                ...
                t.replaceWith('<span class="country-flag"><img class="lazy" data-lazy-src="https://cdn.jsdelivr.net/gh/Loukky/wpcdn/themes/show-useragent/flags/'+i+'.png" title="'+m+'" alt="'+m+'"></span>' );
            })
        })
    }
    $(function(){vfhkyconlocquery()})
